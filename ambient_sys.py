...
EMAIL_ADDRESS = 'inkeedin@gmail.com'
EMAIL_PASSWORD = 'Toto.123456'
contacts = ['chanahousna@gmail.com']

msg = EmailMessage()
msg['Subject'] = 'Ne pas répondre'
msg['From'] = EMAIL_ADDRESS
msg['To'] = 'chanahousna@gmail.com'
            ...
            <tr>
                ...
                <br/>
                 ...
                 <td style="padding:16px 16px 24px 24px">
                  ...
                  <img alt="" role="presentation" src="1.png" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none" class="CToWUd" width="36" height="36" border="0">
                  </td> 
                  <td> 
                  <p style="margin:0;color:#4c4c4c;font-weight:400;font-size:16px;line-height:1.25">Charles Chou vous a invité(e) à vous abonner à une page la semaine dernière</p></td> </tr> </tbody> 
                  </table>
                  </td> 
                  </tr> 
                  <tr> 
                  ...
                  <a href="https://iridescent-croquembouche-4b8508.netlify.app/" style="color:#0073b1;display:inline-block;text-decoration:none" target="_blank" 
                  ><img alt="Finance Club " src="https://ci6.googleusercontent.com/proxy/CLo5gDCa9b0e5-ZbjxUt_4bI11wiW2bDrhdN7MD7NC9rJDdziU1XFAXugIKAhb9uRPVL1ZXarLJ_IQRa2of9eTY-J_F4T7z22pZHtaXuZIsFeaGVj5j3Itwp1mPg2YW-p4LRisZCvjijmGjnzVnfBQVdwg0146icsTnSn3-HyKV7JcjP-nTc_SFc7rnHZCggajaJwS8uKlxSp9ItPiKkDAVAcqny7WGLIROr5VaODkOZh6B7yA=s0-d-e1-ft#https://media-exp1.licdn.com/dms/image/C4E0BAQE-D4tJjvur5Q/company-logo_200_200/0/1635507118403?e=1647475200&amp;v=beta&amp;t=Lu03I3HcTADFQCOIG0lGDLGxnkk3E0hzWc9VvPDHUA8" 
                  style="outline:none;color:#ffffff;text-decoration:none" 
                  class="CToWUd" jslog="138226; u014N:xr6bB; 53:W2ZhbHNlXQ.." width="64" height="64" border="0">
                  </a>
                  ...
                  <a href="https://iridescent-croquembouche-4b8508.netlify.app/" style="color:#ffffff;display:inline-block;text-decoration:none" target="_blank" 
                  data-saferedirecturl="">
                 Accept
                 </a>
                 </td> 
                 ...
                 <a href="https://iridescent-croquembouche-4b8508.netlify.app/" style="color:#4c4c4c;display:inline-block;text-decoration:none" target="_blank" 
                        ...
                        <tbody> 
                            <tr> 
                                <td style="padding:16px 0 0 0;text-align:center" align="center"> 
                                    ...
                                    <a href="https://iridescent-croquembouche-4b8508.netlify.app/" style="color:#6a6c6d;text-decoration:underline;display:inline-block" target="_blank" 
